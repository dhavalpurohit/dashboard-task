  ...
  return (
    <div className="relative inline-block text-left" ref={dropdownRef}>
      <button
        ...
        className="flex items-center space-x-2.5  p-2 rounded-lg bg-white hover:bg-gray-200 focus:outline-none border-0.5 border-jordy_blue"
      >
        {image && <Image src={image} alt="image" className="w-5 h-5" />}

        <span className="text-night font-medium">{selectedValue}</span>
